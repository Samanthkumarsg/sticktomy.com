...
export const NoteCard = () => {
    return (
        <div className="flex flex-col items-start jusitify-start hover:animate-pulse">
            ...
            <div className=" rounded-md w-full flex flex-col items-start justify-start p-4  bg-indigo-50 shadow shadow-indigo-100 -rotate-1  hover:animate-pulse duration-75 cursor-pointer  ">
